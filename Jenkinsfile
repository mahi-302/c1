       ...
       stage('hosting application'){
        steps{
          ...
          script{
           ...
           script{
              def cmd = "aws elbv2 create-load-balancer --name my-load-balancer --subnets subnet-08f3fd927977dc180 subnet-0c9f6c09d2f62dc2d --security-groups sg-03723ff32a5606bda --region us-east-2 "
              def output = sh(script: cmd,returnStdout: true)
          ...
          script{
           ...
           sh "aws autoscaling create-launch-configuration --launch-configuration-name my-lc-cli --image-id ami-0fb653ca2d3203ac1 --instance-type t2.micro --security-groups sg-03723ff32a5606bda --key-name Ec2all --iam-instance-profile role_all --user-data file://userdata.txt --region us-east-2"
